    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-8 col-md-8 col-12">
            <div class="ratio ratio-16x9">
                <iframe src="<?php echo e(asset('player.php')); ?>" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadPoll() {
        axios.post('<?php echo e(route("check.poll")); ?>', { request: 1 })
            .then(res => {
    ...
    $(document).on('click', '#but_vote', async function(e) {
        ...
        try {
            const res = await axios.post('<?php echo e(route("submit.poll.vote")); ?>', {
                request: 2,
                poll: selectedOption,
...
function loadQuestions() {
    axios.post('<?php echo e(route("get-questions")); ?>', { request: 3 })
        .then(res => {
            if (res.data) {
...
function showToastNotification(title, message) {
    ...
    $('.reaction-btn').on('click', function() {
        ...
        axios.post('<?php echo e(route("store-reaction")); ?>', { reaction: type })
    ...
    function playApplause() {
        new Audio('<?php echo e(asset("assets/audio/audience-clapping.mp3")); ?>').play().catch(e => console.log(e));
    }

    // ==================== ACTIVITY TRACKING ====================
    setInterval(() => {
        axios.post('<?php echo e(route("track-activity")); ?>').catch(e => console.log(e));
    }, 240000);

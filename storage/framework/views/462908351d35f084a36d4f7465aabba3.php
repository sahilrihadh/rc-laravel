<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
  ...
  <a class="navbar-brand ps-3" href="<?php echo e(route('admin.dashboard')); ?>">
    <img src="<?php echo e(asset('assets/img/rc-logo.png')); ?>" width="100px" class="img-fluid" alt="">
  </a>
...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    Royal Canin
            ...
            <!-- Navbar Search-->
            <form class="d-none d-md-none form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
              ...
              <ul class="navbar-nav ms-auto ms-md-0 me-0 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="btn btn-logout" href="#" data-bs-toggle="modal" data-bs-target="#logoutModal">Logout</a></li>
                    </ul>
                </li>
            </ul>
            </div>
            
        </nav><?php /**PATH /Users/sahilrihadh/Development/royalcanin/webinar-solution/resources/views/admin/partials/header.blade.php ENDPATH**/ ?>